      ...
      <div className="w-full max-w-7xl mx-auto space-y-16 md:space-y-20">
        ...
        <header className="text-center pt-4 md:pt-8">
          ...
          <blockquote className="italic text-lg md:text-xl text-gray-700 mb-10 md:mb-12 border-l-4 border-yellow-500 pl-6 py-3 max-w-3xl mx-auto bg-white/40 backdrop-blur-sm rounded-r-lg shadow-sm">
            ...
            <br />
            <span className="block mt-2 text-base text-gray-600">— Plato</span>
          </blockquote>
        </header>
          ...
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
            <div className="md:w-3/5 lg:w-1/2">
              ...
              <p className="mb-6 text-lg leading-relaxed">
                ...
                <span className="italic">Rabindra Sangeet</span> (Tagore songs),
                Indian classical vocal, and harmonium. With years of experience
                teaching students of all ages and backgrounds, Nandita offers a
                nurturing, inspiring, and holistic approach to music
                education—both online and in person.
              </p>
            </div>
            <div className="md:w-2/5 lg:w-1/2 flex justify-center items-center mt-6 md:mt-0">
              <div className="w-full max-w-md aspect-[4/3] rounded-xl shadow-lg overflow-hidden">
                <img
        ...
        <section id="testimonials" className="max-w-4xl mx-auto px-2">
        ...
        {/* CTA Section */}
        <section className="text-center pt-8 pb-8 md:pb-12">
          <Link
            href="/contact"
            className="inline-flex items-center px-10 py-4 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-fuchsia-700 transition-colors text-lg md:text-xl transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:ring-opacity-50"
          >
