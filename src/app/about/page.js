...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>
          About Nandita Mukherjee | London Vocalist & Harmonium Player
        </title>
        <meta
          name="description"
          ...
          >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                ...
                performer within the UK&apos;s vibrant cultural landscape.
              </p>
            </div>
          </motion.section>
          ...
          >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-3">
                Discover more of Nandita&apos;s enchanting music and
