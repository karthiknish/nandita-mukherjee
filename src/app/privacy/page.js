...
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Nandita Mukherjee</title>
        <meta
          name="description"
          content="Privacy policy for visitors and students of Nandita Mukherjee, London-based harmonium player and Rabindra Sangeet specialist."
        />
        <meta
          property="og:title"
          content="Privacy Policy | Nandita Mukherjee"
        />
        <meta
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-pink-100 to-indigo-100 flex flex-col items-center justify-start px-4 py-12 font-sans">
        <div className="max-w-2xl w-full bg-white/80 rounded-xl shadow-lg p-8">
          ...
          <p className="mb-4">
            We never share your information with third parties except as
            required by law. Your data is stored securely and only accessible to
